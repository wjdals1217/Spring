...
public class LogAdvice {
	...
	public void insertPointcut() {} // 내용이 없는 참조 메소드
	
	@Pointcut("execution(void ch03.sub3.Service.select())")
	public void selectPointcut() {} // 내용이 없는 참조 메소드
	
	
	@Pointcut("execution(void ch03.sub3.Service.update(*))") public void
	updatePointcut() {} // 내용이 없는 참조 메소드
	  
	@Pointcut("execution(void ch03.sub3.Service.delete(*,*))") public void
	deletePointcut() {} // 내용이 없는 참조 메소드
